<h2 class="h3 text-dark mt-3 mb-3">読書ログ登録</h2>
    <form action="create.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" name="score" class="form-control" id="score" maxlength="1" value="<?php echo $review['score'];?>">
        </div>
        <div class="form-group">
            <label for="impression">感想</label>
            <textarea type="text" name="impression" class="form-control" id="impression" rows=" 10" maxlength="1000"><?php echo $review['impression'];?></textarea>
        </div>
